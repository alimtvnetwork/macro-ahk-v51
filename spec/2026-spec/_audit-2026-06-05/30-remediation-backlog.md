...
2. Add a constant-divergence checker for conflicting default values across folders.
3. Add a score snapshot lock at `_audit-2026-06-05/scores.snapshot.json`.
4. Add no-bare-fetch and footer-lint guards for new prose.
5. Wire every audit check into `.github/workflows/spec-audit.yml`.
