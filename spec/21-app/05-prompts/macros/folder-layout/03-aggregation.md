...
12. **Emit** — atomic write to `chrome-extension/macros/macros.json` (`*.tmp` + rename). Bundle keys: `Version`, `BuildHash`, `GeneratedAt` (Asia/Kuala_Lumpur), `Source: "macros"`, `Count`, `Macros[]`.
