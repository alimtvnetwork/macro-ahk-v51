...
export default tseslint.config(
  ...
  // graduate off this list as their authored-source debt is cleaned.
  {
    files: [
      ...
      "src/background/handlers/schema-meta-handler.ts",
      "src/background/handlers/script-info-handler.ts",
      ...
      "src/background/handlers/xpath-validation-handler.ts",
      ...
      "src/content-scripts/sentinel-reader.ts",
      "src/content-scripts/xpath-capture-coalescer.ts",
      "src/content-scripts/xpath-recorder.ts",
      "src/hooks/__tests__/use-draggable.test.tsx",
      "src/hooks/use-draggable.ts",
      "src/hooks/use-editor-theme.ts",
      ...
      "standalone-scripts/xpath/src/core.ts",
      "standalone-scripts/xpath/src/find-element.ts",
      "standalone-scripts/xpath/src/logger.ts",
