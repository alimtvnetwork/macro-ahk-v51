...
- [Credit Balance Update (v3.50.0)](mem://features/macro-controller/credit-balance-update) — Ktlo/Free/Cancelled fetch /workspaces/{id}/credit-balance on demand; PascalCase Plan+GrantType+CreditFetchOutcome enums; AbortController timeout (slider 500–15000ms, default 3000); dual cache 10-min TTL; single-flight; single auth-retry; resolver feeds tooltip, CSV, refill-priority
