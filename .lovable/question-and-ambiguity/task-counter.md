...
| 18 | 2026-06-02 | Created `spec/2026-spec/README.md` as a thin pointer to the existing complete `spec/2026-prompts-generic/` workstream (T1–T120 + H1–H10 all done). No duplication; reversible to a `git mv` rename later. | [59 — 2026-spec folder name](./59-2026-spec-folder-name.md) |
