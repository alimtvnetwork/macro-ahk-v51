    ...
    const mocks: Record<string, string | number | boolean | null | object> = {
        ...
        GET_PROMPTS: {
            prompts: [
                ...
                { id: "7", name: "Minor Bump", text: "Bump all Minor versions for all.\n\nAlso pin the new version to the root readme.", order: 6, isDefault: true, category: "versioning", createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
                { id: "8", name: "Major Bump", text: "Bump all Major versions for all.\n\nAlso pin the new version to the root readme.", order: 7, isDefault: true, category: "versioning", createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
