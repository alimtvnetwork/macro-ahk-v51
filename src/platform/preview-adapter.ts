    ...
    const mocks: Record<string, string | number | boolean | null | object> = {
        ...
        GET_PROMPTS: {
            prompts: [
                ...
                { id: "16", name: "Write Memory", text: "End-of-session memory persistence: audit done/pending/learned, update .lovable/memory/, plan.md, suggestions.md, pending-issues/, solved-issues/, cicd-issues/ + cicd-index.md, strictly-avoid.md. Lowercase-hyphenated filenames. Trigger phrases: 'write memory', 'end memory', 'update memory'.", order: 15, isDefault: true, category: "onboarding", createdAt: "2026-05-14T00:00:00Z", updatedAt: "2026-05-14T00:00:00Z" },
                { id: "17", name: "Coding Guidelines", text: "Read .lovable memory + all spec/idea files; produce a reliability and failure-chance report (success probability by tier, failure map, corrective actions, readiness decision); set up suggestions workflow at .lovable/memory/suggestions/; create root plan.md with prioritized backlog and a Next task selection section. Do not implement code yet. Trigger phrase: 'coding guidelines'.", order: 16, isDefault: true, category: "onboarding", createdAt: "2026-05-14T00:00:00Z", updatedAt: "2026-05-14T00:00:00Z" },
            ],
        },
