...
function getFallbackDefaultPrompts(): PromptEntry[] {
    return [
        ...
        { id: "default-minor-bump", name: "Minor Bump", text: "Bump the MINOR version (MAJOR.MINOR.PATCH \u2192 MINOR+1, PATCH=0) across all unified-version sites, then:\n\n1. Add a changelog entry in root `changelog.md` (new `## vX.Y.0 \u2014 YYYY-MM-DD` heading, grouped Added/Changed/Fixed/Removed).\n2. Pin the new version in the root `README.md`.\n3. Run `node scripts/check-version-sync.mjs` \u2014 must exit 0.\n4. Run `bunx tsc --noEmit` \u2014 must exit 0.\n\nAll three artifacts (version + changelog + README) must move together.", order: 7, isDefault: true, category: "versioning", createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
        { id: "default-major-bump", name: "Major Bump", text: "Bump the MAJOR version (MAJOR.MINOR.PATCH \u2192 MAJOR+1, MINOR=0, PATCH=0) across all unified-version sites, then:\n\n1. Add a changelog entry in root `changelog.md` (new `## vX.0.0 \u2014 YYYY-MM-DD` heading, grouped Added/Changed/Fixed/Removed/Breaking).\n2. Pin the new version in the root `README.md`.\n3. Run `node scripts/check-version-sync.mjs` \u2014 must exit 0.\n4. Run `bunx tsc --noEmit` \u2014 must exit 0.\n\nAll three artifacts (version + changelog + README) must move together.", order: 8, isDefault: true, category: "versioning", createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
        { id: "default-patch-bump", name: "Patch Bump", text: "Bump the PATCH version (MAJOR.MINOR.PATCH \u2192 PATCH+1) across all unified-version sites, then:\n\n1. Add a changelog entry in root `changelog.md` (new `## vX.Y.Z \u2014 YYYY-MM-DD` heading, grouped Fixed/Changed as applicable).\n2. Pin the new version in the root `README.md`.\n3. Run `node scripts/check-version-sync.mjs` \u2014 must exit 0.\n4. Run `bunx tsc --noEmit` \u2014 must exit 0.\n\nAll three artifacts (version + changelog + README) must move together.", order: 9, isDefault: true, category: "versioning", createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" },
