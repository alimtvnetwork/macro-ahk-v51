...
### macro-ahk-v51 — AutoHotkey sidecar
...
**Repository:** `https://github.com/alimtvnetwork/macro-ahk-v51`  
**Clone command:**
...
- Extension v2.170.0+ requires AHK sidecar v23.x (macro-ahk-v51 branch)
