...
### macro-ahk-v44 — AutoHotkey sidecar
...
**Repository:** `https://github.com/alimtvnetwork/macro-ahk-v44`  
**Clone command:**
...
The `macro-ahk-v44/` folder must sit adjacent to this repository root:
...
macro-ahk-v44/                # Clone target (sidecar)
├── scripts/
├── lib/
└── ...
```
...
- Extension v2.170.0+ requires AHK sidecar v23.x (macro-ahk-v44 branch)
