...
**Repository:** `https://github.com/alimtvnetwork/macro-ahk-v32`  
**Clone command:**

```bash
git clone https://github.com/alimtvnetwork/macro-ahk-v32 "macro-ahk"
```
...
- Extension v2.170.0+ requires AHK sidecar v23.x (macro-ahk-v32 branch)
