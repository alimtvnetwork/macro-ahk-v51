...
```powershell
$env:MARCO_DL_VERSION='v3.39.0'; $env:MARCO_DL_FOLDER='marco'; irm https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v43/main/scripts/download-extension.ps1 | iex
```
...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/macro-ahk-v43/releases/download/v3.39.0/install.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v43/releases/download/v3.39.0/install.sh | bash
```
