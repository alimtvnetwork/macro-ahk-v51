...
function _showHistoryDetailModal(row: any): void {
  ...
  modal.style.cssText = 'background:' + (state.cPanelBg || '#1a1625') + ';border:1px solid ' + (state.cPanelBorder || '#2d2b3b') + ';border-radius:12px;width:90%;max-width:600px;max-height:85vh;display:flex;flex-direction:column;box-shadow:0 30px 70px rgba(0,0,0,0.6);overflow:hidden;';
